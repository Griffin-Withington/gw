...
#
#
# FOR PLOTTING - WILL RETURN TO LATER
#
# 
...
print(eval_season(df, d1, "no"))
    


    
def simulate(seasons, fle, teams, div):
...
tb = simulate(10, "fftest.csv", teams, d1)
